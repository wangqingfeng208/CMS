		...
		<div class="row">
			...
			<div class="col-md-2 ">
				<ul class="list-group text-center">
					<li class="list-group-item cms-list-group-item-action ${c.id==article.channelId?"cms-list-group-item-active":""}">
						<a href="/?hot=1" class="channel">热门 </a>
					</li>
				</ul>
			...
			<div class="col-md-7 split min_h_500">
				...
				<c:if test="${article.channelId==null}">
					...
					<div class="bd-example">
						<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<img src="/png/1.jpg" class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">
								<h5>图片一</h5>
								</div>
								</div>
								<div class="carousel-item">
								<img src="/png/2.jpg" class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">
								<h5>图片二</h5>
								</div>
							</div>
							<div class="carousel-item">
								<img src="/png/3.jpg" class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">
								<h5>图片三</h5>
								</div>
							</div>
					...
					<div>
						<c:forEach items="${hotArticles}" var="a">
							<div class="media">
								<img src="/png/${a.picture }" class="mr-3" alt="..." style="width: 190px;height:124px ">
				...
				<c:if test="${article.channelId!=null}">
					<div>
						<!--显示栏目下分类  -->
						<ul class="nav">
							<li class="nav-item ${c.id==article.categoryId?"cms-list-group-item-active":"" } ">
							<a class="nav-link" href="?channelId=${article.channelId}">全部</a>
							</li>
							<c:forEach items="${categorys}" var="c">
								<li class="nav-item ${c.id==article.categoryId?"cms-list-group-item-active":"" } ">
									<a class="nav-link" href="?channelId=${c.channelId}&categoryId=${c.id}">${c.name }</a>
								</li>
							</c:forEach>
						</ul>
					</div>
					...
					<div class="card" style="width: 18rem;">
						...
						<div class="card-body">
							<c:forEach items="${articlepics}" var="a">
								<div class="media">
									<img src="/png/${a.picture}" class="mr-3" alt="..."
